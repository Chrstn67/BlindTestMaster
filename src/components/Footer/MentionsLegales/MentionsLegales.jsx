  ...
  return (
    <section className="mentions">
      <p>
        ...
        https://chrstn67.github.io/BlindTestMaster/#/ l'identité des différents
      ...
      <p>
        ...
        https://chrstn67.github.io/BlindTestMaster/#/. Christian HUMBERT décline
        toute responsabilité quant à l’utilisation qui pourrait être faite des
        informations et contenus présents sur
        https://chrstn67.github.io/BlindTestMaster/#/. Christian HUMBERT
        s’engage à sécuriser au mieux le site
        https://chrstn67.github.io/BlindTestMaster/#/, cependant sa
      ...
      <p>
        ...
        du site https://chrstn67.github.io/BlindTestMaster/#/ dispose d’un droit
        d’accès, de modification et de suppression des informations collectées.
        Pour exercer ce droit, envoyez un message à notre Délégué à la
        Protection des Données : Christian HUMBERT - chrstn.hmbrt67@outlook.com.
      </p>

      <p>
        5 - Liens hypertextes et cookies : Le site
        https://chrstn67.github.io/BlindTestMaster/#/ contient des liens
        ...
        https://chrstn67.github.io/BlindTestMaster/#/.
      </p>

      <p>
        6 - Droit applicable et attribution de juridiction : Tout litige en
        relation avec l’utilisation du site
        https://chrstn67.github.io/BlindTestMaster/#/ est soumis au droit

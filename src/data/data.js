...
export const manches = [
  {
    ...
    nom: "Easy BlindTest",
    description:
      "Devinez le plus vite possible le titre et/ou l'artiste de la chanson",
    emoji: "🎵",
    points: "1 point pour l'artiste, 1 point pour le titre",
    effet: null,
  },
  {
    id: 2,
    nom: "dnilBtseT",
    description: "Devine la chanson... jouée à l'envers",
    emoji: "🔄",
    points: "3 points pour l'artiste, 3 points pour le titre",
    effet: "inverse",
  },
  {
    id: 3,
    nom: "X-trem BlindTest",
    description:
      "Devine la chanson cachée dans les effets sonores improbables...",
    emoji: "👹",
    points: "4 points pour l'artiste, 4 points pour le titre",
    effet: "monstre",
  },
];
...
export const chansons = [
  {
    id: 1,
    titre: "L'effet de Masse",
    artiste: "Maëlle",
    audioUrl: "./audio/Maelle-LeffetDeMasse.mp3",
    paroles:
  ...
  },
  {
    id: 2,
    titre: "Lean On",
    artiste: "Major Lazer ft. DJ Snake & MO",
    audioUrl: "./audio/Lean-On.mp3",
    paroles:
  ...
  {
    id: 3,
    titre: "Waka Waka (Spanish Version)",
    artiste: "Shakira",
    audioUrl: "./audio/Waka-Waka_Spanish.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Le temps",
    artiste: "Tayc",
    audioUrl: "./audio/Tayc-Le temps.mp3",
    paroles:
  ...
  {
    id: 5,
    titre: "Laissons entrer le soleil",
    artiste: "Julien Clerc",
    audioUrl: "./audio/Julien-Clerc_Laissons-entrer-le-soleil.mp3",
    paroles:
  ...
  {
    id: 6,
    titre: "Les yeux de la mama",
    artiste: "Kendji Girac",
    audioUrl: "./audio/Les-yeux-de-la-mama.mp3",
    paroles:
  ...
  },
  {
    ...
    artiste: "Queen",
    audioUrl: "./audio/The-Show-Must-Go-On.mp3",
    paroles:
  ...
  {
    id: 8,
    titre: "Robin Schulz & Rita Ora & Tiago PZK",
    artiste: "I'll Be There",
    audioUrl: "./audio/Rita-Ora_Ill-Be-There.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Le Pire",
    artiste: "GIMS",
    audioUrl: "./audio/GIMS-Le Pire.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Le déserteur",
    artiste: "Boris Vian",
    audioUrl: "./audio/Boris-Vian_Le-deserteur.mp3",
    paroles:
  ...
  },
  {
    id: 11,
    titre: "Tuesday",
    artiste: "Burak Yeter ft. Danelle Sandoval",
    audioUrl: "./audio/BurakYeter-Tuesday.mp3",
    paroles:
  ...
  {
    id: 12,
    titre: "Ain't Nobody (Loves Me Better)",
    artiste: "Felix Jaehn ft. Jasmine Thompson",
    audioUrl: "./audio/Felix-Jaehn_Aint-Nobody.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Ces-Gens-La.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Rodéo",
    artiste: "Zazie",
    audioUrl: "./audio/Zazie-Rodeo.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/JamesArthur-Impossible.mp3",
    paroles:
  ...
  },
  {
    id: 17,
    titre: "I Adore You",
    artiste: "HUGEL, Topic, Arash ft. Daecolm",
    audioUrl: "./audio/Hugel-IAdoreYou.mp3",
    paroles:
  ...
  },
  {
    id: 18,
    titre: "Te Imaginaba",
    artiste: "Alvaro Soler",
    audioUrl: "./audio/Alvaro-Soler_Te-Imaginaba.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Burn_Ellie-Goulding.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Imagine-Dragons_Thunder.mp3",
    paroles:
  ...
  {
    id: 21,
    titre: "Ma p'tite étoile",
    artiste: "Hatik",
    audioUrl: "./audio/Hatik_Ma-Petite-Etoile.mp3",
    paroles:
  ...
  },
  {
    id: 22,
    titre: "Kids",
    artiste: "OneRepublic ft. Seeb",
    audioUrl: "./audio/OneRepublic–Kids.mp3",
    paroles:
  ...
  },
  {
    ...
    artiste: "Adele",
    audioUrl: "./audio/Adele_Rolling-In-The-Deep.mp3",
    paroles:
  ...
  },
  {
    id: 28,
    titre: "Jerusalema",
    artiste: "Master KG ft. Burna Boy & Nomcebo Zikode",
    audioUrl: "./audio/Master-KG_Jerusalema.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Florent-Pagny_Chanter.mp3",
    paroles:
  ...
  {
    id: 30,
    titre: "Prosper (Yop la boum)",
    artiste: "Maurice Chevalier",
    audioUrl: "./audio/Maurice-Chevalier_Prosper.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Black-or-White.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Too Close",
    artiste: "Alex Clare",
    audioUrl: "./audio/Alex-Clare_Too-Close.mp3",
    paroles:
  ...
  {
    id: 35,
    titre: "The Emptiness Machine",
    artiste: "Linkin Park",
    audioUrl: "./audio/Linkin_Park_The-Emptiness-Machine.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Runaway",
    artiste: "AURORA",
    audioUrl: "./audio/Aurora-Runaway.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Messy",
    artiste: "Lola Young",
    audioUrl: "./audio/Lola-Young _Messy.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "It's My Life",
    artiste: "Bon Jovi",
    audioUrl: "./audio/Its-My-Life_Bon-Jovi.mp3",
    paroles:
  ...
  {
    id: 39,
    titre: "Qui a le droit",
    artiste: "Patrick Bruel",
    audioUrl: "./audio/PatrickBruel_Qui-a-le-droit.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "On verra",
    artiste: "Nekfeu",
    audioUrl: "./audio/Nekfeu_On-verra.mp3",
    paroles:
  ...
  },
  {
    ...
    audioUrl: "./audio/Black-Eyed-Peas_Pump-It.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "All of Me",
    artiste: "John Legend",
    audioUrl: "./audio/John-Legend_All-of-Me.mp3",
    paroles:
  ...
  {
    id: 44,
    titre: "Ramenez la coupe à la maison",
    artiste: "Vegedream",
    audioUrl: "./audio/Vegedream_Ramenez-la-coupe.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Reine",
    artiste: "Dadju",
    audioUrl: "./audio/Dadju-Reine.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Dommage",
    artiste: "Bigflo & Oli",
    audioUrl: "./audio/Bigflo-et-Oli_Dommage.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Firework",
    artiste: "Katy Perry",
    audioUrl: "./audio/Katy-Perry_Firework.mp3",
    paroles:
  ...
  {
    id: 50,
    titre: "Parado no Bailão",
    artiste: "MC L da Vinte ft. MC Gury",
    audioUrl: "./audio/MC-l-da-vinte-e-mc-gury_parado-no-bailao.mp3",
    paroles:
  ...
  },
  {
    ...
    titre: "Pour de vrai",
    artiste: "Vianney",
    audioUrl: "./audio/Vianney_Pour-de-vrai.mp3",
    paroles:
  ...
  {
    id: 52,
    titre: "Bad Guy (Sasha Vector Remix)",
    artiste: "Billie Eilish",
    audioUrl: "./audio/Billie-Eilish_Bad-Guy.mp3",
    paroles:
  ...
  },
  {
    id: 53,
    titre: "Promis Juré",
    artiste: "Lilian Renaud",
    audioUrl: "./audio/Promis-jure_Lilian-Renaud.mp3",
    paroles:
  ...
  },
  {
    id: 54,
    titre: "The Ocean",
    artiste: "Mike Perry ft. Shy Martin",
    audioUrl: "./audio/Mike-Perry_The-Ocean.mp3",
    paroles:
  ...
  },
  {
    id: 55,
    titre: "Lordly",
    artiste: "FEDER ft. Alex Aiono (MDZN remix)",
    audioUrl: "./audio/Lordly-FEDER.mp3",
    paroles:
...
// Par exemple, des catégories de musique, des niveaux de difficulté, etc.
